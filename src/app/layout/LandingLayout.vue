<template>
    <a-layout>
        <a-spin :spinning="isLoading" tip="Cargando página...">
                ...
                <div class="container d-flex align-items-center">
                    ...
                    <nav id="navbar" class="navbar">
                        <ul>
                            ...
                            <li>
                                <a class="nav-link scrollto" href="#delegate">Delegar servicio</a>
                            </li>
                            <li>
                                <a class="nav-link scrollto" href="#services">Ventajas</a>
                            </li>
                            <li>
                ...
                <div class="container">
                    <div class="row">
                        <div
                            ...
                            data-aos-delay="200"
                        >
                            <h1>Facturación en línea para tu negocio</h1>
                            <h2>
                                Desde nuestro servicio podrá emitir comprobantes de venta, listarlos, enviarlos por
            ...
            <main id="main">
                <!-- ======= Why Us Section ======= -->
                <section id="delegate" class="why-us section-bg">
                    <div class="container-fluid" data-aos="fade-up">
                        <div class="row">
                            ...
                            >
                                <div class="content">
                                    <h3>
                                        <strong>Delegar servicio de facturación electrónica</strong>
                                    </h3>
                                    <p>
                                        Para obtener los beneficios de la factura electrónica de AFIP en línea, primero
                                        deberá delegar el servicio a nuestro nombre. Delegar el acceso al servicio web
                                        de Facturación Electrónica de AFIP implica otorgar permisos a una entidad o
                                        aplicación externa (DMIT Facturación en línea) para que interactúe con el
                                        sistema de facturación electrónica de AFIP en tu nombre. Aquí tienes los pasos
                                ...
                                <div class="accordion-list">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            >
                                                <p>
                                                    Delegar el web service de factura electrónica de AFIP significa que
                                                    un tercero autorizado (DMIT Facturación en línea) se encargará de
                                                    emitir las facturas electrónicas en tu nombre. Esto te permite
                                                    ahorrar tiempo y esfuerzo, y asegurarte de que tus facturas cumplen
                                                    con todas las normas de AFIP.
                                                </p>
                                            </div>
                                        </li>
                ...
                <section id="services" class="services section-bg">
                    <div class="container" data-aos="fade-up">
                        <div class="section-title">
                            <h2>Ventajas</h2>
                            <!-- <p>
							La factura electrónica de AFIP permite a las empresas reducir costos en la emisión y
							almacenamiento de facturas en papel, así como en el envío y recepción de documentos físicos.
						</p> -->
                        </div>
                        <div class="row">
                            <div
                            ...
                            >
                                <div class="icon-box align-items-center">
                                    ...
                                    <h4><a href="">Ahorro de Tiempo y Costos</a></h4>
                                    <p>
                                        Ahorro significativo de tiempo y costos en el procesamiento de facturas, al
                                        eliminar la necesidad de imprimir y enviar facturas físicas, se reducen los
                                        costos asociados con la impresión, el envío y el almacenamiento de documentos en
                                        papel. Además,reduce el tiempo y los errores asociados con el procesamiento
                                        manual de facturas.
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                <div class="icon-box">
                                    <div class="icon"><i class="bx bx-sidebar"></i></div>
                                    <h4><a href="">Seguridad</a></h4>
                                    <p>
                                        Mayor seguridad y confidencialidad de los datos, ya que se utilizan sistemas
                                        encriptados y autenticación de usuarios.
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                <div class="icon-box">
                                    ...
                                    <h4><a href="">Mejora de productividad</a></h4>
                                    <p>
                                        La implementación de la factura electrónica de AFIP automatiza los procesos de
                                        facturación, lo que permite a las empresas mejorar su productividad y dedicar
                                        más tiempo a actividades de mayor valor agregado.
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                <div class="icon-box">
                                    ...
                                    <h4><a href="">Reducción de errores</a></h4>
                                    <p>
                                        La factura electrónica de AFIP reduce significativamente los errores de
                                        facturación gracias a la validación automática de datos y la eliminación de la
                                        necesidad de ingresar información manualmente.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul>
                                <li data-aos="fade-up" data-aos-delay="100">
                                    ...
                                    <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                                        <p>
                                            ...
                                            validez legal que la factura en papel. Se emite y recibe en formato
                                            electrónico, y permite agilizar y transparentar el proceso de facturación.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
                                        <p>
                                            La obligación de emitir facturas electrónicas depende de la categoría fiscal
                                            del contribuyente, la actividad que desarrolla y el monto de sus
                                            facturaciones. Puedes consultar si estás obligado en el sitio web de AFIP:
                                ...
                                <li data-aos="fade-up" data-aos-delay="400">
                                    ...
                                    <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
                                        <p>
                                            Para emitir facturas electrónicas necesitas: Un certificado digital de AFIP,
                                            un software de facturación electrónica homologado o un proveedor de
                                            servicios de facturación electrónica y una conexión a internet.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li data-aos="fade-up" data-aos-delay="500">
                                    ...
                                    <div id="faq-list-7" class="collapse" data-bs-parent=".faq-list">
                                        <p>
                                            Si tienes problemas para emitir facturas electrónicas, puedes consultar la
                                            ayuda online de AFIP o contactarte con el soporte técnico de tu proveedor de
                                            software o servicios de facturación electrónica.
                                        </p>
                                    </div>
                                </li>
                                <li data-aos="fade-up" data-aos-delay="500">
                                    ...
                                    <div id="faq-list-8" class="collapse" data-bs-parent=".faq-list">
                                        <p>
                                            Puedes consultar el estado de tus facturas electrónicas en el sitio web de
                                            AFIP:
                                            <a-typography-link
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-3 col-md-6 footer-contact">
                                <h3>DMIT</h3>
                                <strong>Email:</strong> info@dmit.ar<br />
                            </div>
