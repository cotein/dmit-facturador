...
import FormCompany from '@/app/components/company/FormCompany.vue';
...
const handleCustomEvent = (data: CompanyRawData) => {
	console.log('🚀 ~ file: Aside.vue:54 ~ handleCustomEvent ~ data:', data);
...
<template>
	...
	>
		<CreateCompanyForm @submitCompanyForm="handleCustomEvent" :loadingButton="!createCompanyMutation.isLoading" />
	</a-drawer>
	...
	>
		...
		<a-sub-menu key="customers">
			...
			<a-menu-item @click="toggleCollapsed" key="customers-cuentas-corrientes">
				<router-link :to="{ name: 'ListCuentasCorrientes' }"> Cuentas Corrientes </router-link>
			</a-menu-item>
		</a-sub-menu>
