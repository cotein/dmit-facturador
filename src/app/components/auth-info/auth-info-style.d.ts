declare const InfoWraper: import('vue').DefineComponent<
    {
        ...
        find?:
            | {
                  <S_2 extends string>(
                      predicate: (this: void, value: string, index: number, obj: string[]) => value is S_2,
                      thisArg?: any,
                  ): S_2 | undefined;
                  (predicate: (value: string, index: number, obj: string[]) => unknown, thisArg?: any):
                      | string
                      | undefined;
              }
            | undefined;
        findIndex?:
            | ((predicate: (value: string, index: number, obj: string[]) => unknown, thisArg?: any) => number)
            | undefined;
        ...
        flatMap?:
            | (<U_3, This = undefined>(
                  callback: (this: This, value: string, index: number, array: string[]) => U_3 | readonly U_3[],
    ...
    {}
>;
declare const SettingDropdown: import('vue').DefineComponent<
    import('vue').HTMLAttributes,
    {},
    {},
    import('vue').ComputedOptions,
    ...
    string,
    import('vue').VNodeProps & import('vue').AllowedComponentProps & import('vue').ComponentCustomProps,
    Readonly<import('vue').HTMLAttributes>,
    {
        class?: any;
        inlist?: any;
    }
>;
declare const NestedDropdown: import('vue').DefineComponent<
    import('vue').HTMLAttributes,
    {},
    {},
    import('vue').ComputedOptions,
...
>;
declare const UserDropDown: import('vue').DefineComponent<
    import('vue').HTMLAttributes,
    {},
    {},
    import('vue').ComputedOptions,
...
>;
declare const NinjadashTopDropdown: import('vue').DefineComponent<
    import('vue').HTMLAttributes,
    {},
    {},
    import('vue').ComputedOptions,
...
>;
declare const NavAuth: import('vue').DefineComponent<
    import('vue').HTMLAttributes,
    {},
    {},
    import('vue').ComputedOptions,
