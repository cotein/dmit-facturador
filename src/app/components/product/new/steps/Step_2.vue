    ...
    >
      <a-row justify="space-between" align="middle" :gutter="31">
        <a-col :span="3">
          <a-form-item ref="quantity" label="Cantidad inicial" name="quantity">
            <a-input
              v-model:value="productStore.product.quantity"
        ...
        <a-col :span="3">
          <a-form-item ref="critical_stock" label="Stock crítico" name="critical_stock">
            <a-input
              v-model:value="productStore.product.critical_stock"
              placeholder="Cantidad"
            />
          </a-form-item>
        </a-col>
        ...
        <a-col :span="3">
          <a-form-item
            ref="meters_by_unity"
            label="Metros de cada unidad"
            name="meters_by_unity"
          >
            <a-input
      ...
      <a-row justify="space-between" align="middle" :gutter="31">
        <a-col :span="3">
          <a-form-item
            ref="view_price"
            label="Visualizar precio en la tienda"
            name="view_price"
          >
            <a-switch
        ...
        <a-col :span="4">
          <a-form-item ref="iva" label="Iva del producto" name="iva">
            <p v-if="IvaZeroPercent">
              De acuerdo a su inscripción en AFIP sus artículos no gravan IVA
            </p>
            <a-select
              v-else
