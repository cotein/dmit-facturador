...
const onClick = (item: { keyPath: any }) => {
	console.log('🚀 ~ file: Aside.vue:39 ~ onClick ~ item:', item);
	...
	>
		...
		<a-sub-menu key="sales">
			...
			<a-menu-item @click="toggleCollapsed" key="vouchers">
				<router-link to="/app/mail/inbox"> Comprobantes </router-link>
			</a-menu-item>
			<a-menu-item @click="toggleCollapsed" key="generate">
				<router-link to="/app/mail-single/1585118055048"> Generar comprobante</router-link>
			</a-menu-item>
		</a-sub-menu>
		...
		<a-sub-menu key="customers">
			...
			<a-menu-item @click="toggleCollapsed" key="privateSingle">
				<router-link to="/app/chat/private/rofiq@gmail.com"> Nuevo </router-link>
			</a-menu-item>
