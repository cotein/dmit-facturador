				...
				<div class="ninjadash-card-nav">
					<ul>
						<li :class="marketingCampaigns === 'today' ? 'ninjadash-active' : 'ninjadash-year'">
							<router-link @click="(event: any) => handleChangeLocation('today', event)" to="#">
								Today
							</router-link>
						</li>
						<li :class="marketingCampaigns === 'week' ? 'ninjadash-active' : 'ninjadash-week'">
							<router-link @click="(event: any) => handleChangeLocation('week', event)" to="#">
								Week
							</router-link>
						</li>
						<li :class="marketingCampaigns === 'month' ? 'ninjadash-active' : 'ninjadash-month'">
							<router-link @click="(event: any) => handleChangeLocation('month', event)" to="#">
								Month
							</router-link>
						</li>
					</ul>
