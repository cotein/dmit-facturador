					...
					<div class="ninjadash-card-nav">
						<ul>
							<li :class="sellerTab === 'today' ? 'ninjadash-active' : 'ninjadash-today'">
								<router-link @click="(e: any) => handleTabActivation(e, 'today')" to="#">
									Today
								</router-link>
							</li>
							<li :class="sellerTab === 'week' ? 'ninjadash-active' : 'ninjadash-week'">
								<router-link @click="(e: any) => handleTabActivation(e, 'week')" to="#">
									Week
								</router-link>
							</li>
							<li :class="sellerTab === 'month' ? 'ninjadash-active' : 'ninjadash-month'">
								<router-link @click="(e: any) => handleTabActivation(e, 'month')" to="#">
									Month
								</router-link>
							</li>
						</ul>
