						...
						<div class="ninjadash-card-nav">
							<ul>
								<li :class="earningsTab === 'today' ? 'ninjadash-active' : 'ninjadash-today'">
									<router-link @click="(event: any) => handleTabActivation('today', event)" to="#">
										Today
									</router-link>
								</li>
								<li :class="earningsTab === 'week' ? 'ninjadash-active' : 'ninjadash-week'">
									<router-link @click="(event: any) => handleTabActivation('week', event)" to="#">
										Week
									</router-link>
								</li>
								<li :class="earningsTab === 'month' ? 'ninjadash-active' : 'ninjadash-month'">
									<router-link @click="(event: any) => handleTabActivation('month', event)" to="#">
										Month
									</router-link>
								</li>
							</ul>
