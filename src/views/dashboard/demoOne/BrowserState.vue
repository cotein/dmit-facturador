                    ...
                    <div class="ninjadash-card-nav">
                        <ul>
                            <li :class="browserTab === 'today' ? 'ninjadash-active' : 'ninjadash-today'">
                                <router-link @click="(e: any) => handleChangePeriod(e, 'today')" to="#">
                                    Today
                                </router-link>
                            </li>
                            <li :class="browserTab === 'week' ? 'ninjadash-active' : 'ninjadash-week'">
                                <router-link @click="(e: any) => handleChangePeriod(e, 'week')" to="#">
                                    Week
                                </router-link>
                            </li>
                            <li :class="browserTab === 'month' ? 'ninjadash-active' : 'ninjadash-month'">
                                <router-link @click="(e: any) => handleChangePeriod(e, 'month')" to="#">
                                    Month
                                </router-link>
                            </li>
                        </ul>
