                ...
                <div class="ninjadash-card-nav">
                    <ul>
                        <li :class="locations === 'today' ? 'ninjadash-active' : 'ninjadash-today'">
                            <router-link @click="(e: any) => handleActiveChangeLocation(e, 'today')" to="#">
                                Today
                            </router-link>
                        </li>
                        <li :class="locations === 'week' ? 'ninjadash-active' : 'ninjadash-week'">
                            <router-link @click="(e: any) => handleActiveChangeLocation(e, 'week')" to="#">
                                Week
                            </router-link>
                        </li>
                        <li :class="locations === 'month' ? 'ninjadash-active' : 'ninjadash-month'">
                            <router-link @click="(e: any) => handleActiveChangeLocation(e, 'month')" to="#">
                                Month
                            </router-link>
                        </li>
                    </ul>
