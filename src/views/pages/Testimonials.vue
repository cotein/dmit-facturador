                                ...
                                <Swiper v-bind="paramsTwo" navigation>
                                    ...
                                    >
                                        ...
                                        <div class="testimonial-block__review">
                                            <p>
                                                It is a long established fact that a reader will page when looking at
                                                its was layout. The point of be distracted by the readable will page
                                                when looking at its was layout will page when looking.
                                            </p>
                                        </div>
                                    </SwiperSlide>
                                </Swiper>
                                            ...
                                            <div class="testimonial-block__inner">
                                                <div class="testimonial-block__review">
                                                    <p>
                                                        ...
                                                        looking at its was layout. The point of be distracted by the
                                                        readable will page when looking at its was layout will page when
                                                        looking.
                                                    </p>
                                                </div>
                                                <div class="testimonial-block__author">
                                ...
                                <Swiper v-bind="paramsThree" navigation>
                                    ...
                                    >
                                        <div class="testimonial-block__inner">
                                            ...
                                            <div class="testimonial-block__review">
                                                <p>
                                                    It is a long established fact that a reader will page when looking
                                                    at its was layout. The point of be distracted by the readable will
                                                    page when looking at its was layout will page when looking.
                                                </p>
                                            </div>
                                            <div class="author-info">
                                                <h2 class="client-name">{{ user.name }}</h2>
