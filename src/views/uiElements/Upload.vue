...
import BasicUpload from './upload/Basic.vue';
import AvatarUpload from './upload/Avatar.vue';
import CompleteControlUpload from './upload/CompleteControl.vue';
import DefaultUpload from './upload/Default.vue';
</script>
